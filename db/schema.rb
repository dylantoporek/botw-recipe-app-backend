...
ActiveRecord::Schema[7.0].define(version: 2022_02_09_210331) do
  ...
  create_table "ingredients", force: :cascade do |t|
    ...
    t.index ["store_id"], name: "index_ingredients_on_store_id"
  end
  ...
  create_table "recipe_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ingredient_id"], name: "index_recipe_lists_on_ingredient_id"
  ...
  add_foreign_key "recipe_lists", "ingredients"
